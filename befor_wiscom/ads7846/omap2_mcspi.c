...
#define OMAP2_MCSPI_SYST_SPIDATDIR1 BIT(9)
#define OMAP2_MCSPI_SYST_SPIDATDIR0 BIT(8)
...
static void omap2_mcspi_set_master_mode(struct spi_master *master)
{
	...
	MOD_REG_BIT(l, OMAP2_MCSPI_MODULCTRL_MS, 0);//set master mode
    ...
    printk("OMAP2_MCSPI_SYST reg is 0x%x(default)\n",l);
    MOD_REG_BIT(l, OMAP2_MCSPI_SYST_SPIDATDIR0,1);//set spi_data[0] output
    MOD_REG_BIT(l, OMAP2_MCSPI_SYST_SPIDATDIR1,1);//set spi_data[1] input
    mcspi_write_reg(master,OMAP2_MCSPI_SYST,l);
    l = mcspi_read_reg(master,OMAP2_MCSPI_SYST);
    printk("OMAP2_MCSPI_SYST reg is 0x%x(modified)\n",l);
    */
    //-=-=-=--=
